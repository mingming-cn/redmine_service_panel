module Gitlab
  class Api < HttpHelper
    module Tags
      ...
      # @option options [String] :order_by Return tags ordered by name, updated, or version. Default is updated..
      # @option options [String] :search Return list of tags matching the search criteria.
      ...
      def create_tag(project, tag_name, ref, message = '', description = nil)
        post("/projects/#{url_encode project}/repository/tags",
             body: { tag_name: tag_name, ref: ref, message: message, release_description: description })
      end
      ...
      def create_release(project, tag, description)
        post("/projects/#{url_encode project}/repository/tags/#{url_encode tag}/release",
      ...
      def update_release(project, tag, description)
        put("/projects/#{url_encode project}/repository/tags/#{url_encode tag}/release",
            body: { description: description })
      end
